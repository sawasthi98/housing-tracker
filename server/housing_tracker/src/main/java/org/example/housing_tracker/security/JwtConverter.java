package org.example.housing_tracker.security;
...
public class JwtConverter {
    ...
    private final String APP_USER_ID_KEY = "app_user_id";

    public String getTokenFromUser(UserDetails user, int appUserId) {
